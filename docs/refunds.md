...
class CreatePaystackRefund
{
    public function __construct(
        private CreateRefundAction $createRefund,
    ) {}
...
class RetryPaystackRefund
{
    public function __construct(
        private RetryRefundAction $retryRefund,
    ) {}

    public function handle(): void
    {
        $refund = ($this->retryRefund)(
            RetryRefundInputData::from([
                'id' => 1234567,
                'refundAccountDetails' => RefundAccountDetailsInputData::from([
                    'currency' => 'NGN',
...
$refund = Paystack::fetchRefund(FetchRefundInputData::from(['id' => 1234567]));
```

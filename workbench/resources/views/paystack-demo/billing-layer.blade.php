<x-paystack-demo.layout title="Billing Layer Demo" heading="Billing layer"
    ...
    <section class="border border-slate-200 bg-white p-5">
        <div class="grid gap-4 md:grid-cols-2">
            <form method="post" action="/paystack/demo/billing-layer"
                ...
                <label class="mt-3 block text-sm font-medium text-slate-700">Name
                    <input name="name" type="text" value="Billable Demo User"
                        class="mt-1 w-full border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 placeholder-slate-400 focus:border-orange-400 focus:outline-none">
                </label>
                <button
                    class="mt-4 bg-orange-400 px-4 py-2.5 text-sm font-semibold text-slate-950 hover:bg-orange-500">Sync
                    customer</button>
            </form>
            ...
            <form method="post" action="/paystack/demo/billing-layer"
                ...
                <button
                    class="mt-4 border border-slate-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50">Create
                    subscription</button>
            </form>
        </div>
